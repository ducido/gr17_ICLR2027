...
_CLASSNAMES = ["drawer1", "drawer2", "drawer3", "red block", 'robot', 'banana', 'pot', 'lid', 'pin1', 'pin2', 'jig']

_BACKGROUND_CLASSNAMES = ['floor', 'wall', 'ceiling']

_NAME_TO_ALIAS_GDINO = {
    'drawer1': 'cabinet with blue drawers',
    'drawer2': 'cabinet with pink drawers',
    'drawer3': 'cabinet with yellow drawers',
