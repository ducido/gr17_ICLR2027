...
class DualIAATransform(DualTransform):
    ...
    def get_params(self):
        return {"deterministic_processor": self.processor.to_deterministic()}

    def apply(self, img, deterministic_processor=None, **params):
        return deterministic_processor.augment_image(img)

    def apply_to_mask(self, mask, deterministic_processor=None, **params):
        return deterministic_processor.augment_image(mask)
